...
<body class="app_version" data-spy="scroll" data-target="#navbarApp" data-offset="98">
    ...
    <header class="header header_style_01">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="index.html"><img src="assets/user/images/logos/logo-app.png"
                        alt="image"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarApp">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="#features">Tính năng</a></li>
                        <li><a class="nav-link" href="#screenshots">Giao diện</a></li>
                        <li><a class="nav-link" href="#team">Đội ngũ phát triển</a></li>
                        <li><a class="nav-link" href="#pricing">Dịch vụ</a></li>
                        <li><a class="nav-link" href="#testimonials">Đánh giá</a></li>
                        <li><a class="nav-link" href="#purchase">Mua</a></li>
                        <li><a class="nav-link" href="#support">Liên hệ</a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="big-tagline">
                        <h2>Appfast App dùng để làm gì?</h2>
                        <p class="lead">Appfast Mobile App hỗ trợ xem trước thời gian thực ứng dụng ngay khi bạn đang
                            chỉnh sửa ứng dụng trên Bảng điều khiển (Dashboard). Bằng cách này, bạn có thể hình dung rõ
                            ràng nhất ứng dụng của bạn khi hoạt động trên thiết bị thật sẽ như thế nào.</p>
                        <a data-scroll href="#order" class="btn btn-light btn-radius btn-brd"><i class="fa fa-play"
                                aria-hidden="true"></i> GooglePlay </a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a data-scroll href="#screenshots" class="btn btn-light btn-radius btn-brd"><i
    ...
    <div id="features" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Appfast là nền tảng xây dựng ứng dụng di động, cho phép bạn xây dựng ứng dụng của mình
                    mà không cần kiến thức về lập trình. Appfast tạo ứng dụng dựa trên các widget được định nghĩa sẵn
                    cùng khả năng tùy chỉnh các thuộc tính như màu sắc, hình ảnh, liên kết... tùy thuộc vào mục đích của
                    bạn. Appfast hỗ trợ xem trước thời gian thực ứng dụng mà bạn đang tạo bằng ứng dụng Appfast Mobile
                    App.</p>
            </div><!-- end title -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 left-row">
                    <ul class="features-left">
                        <li class="highlight lhgh" data-index="0">
                            ...
                            <div class="fl-inner">
                                <h4>Tiện ích (Widget)</h4>
                                <p>Widget (Tiện ích) là những thành phần để xây dựng nên ứng dụng của bạn.</p>
                            </div>
                        ...
                        <li class="highlight lhgh" data-index="1">
                            ...
                            <div class="fl-inner">
                                <h4>Xóa một ứng dụng đã tải lên Cửa hàng</h4>
                                <p>Ứng dụng đã được đưa lên Cửa hàng sẽ không bị xoá khỏi Cửa hàng</p>
                            </div>
                        </li><!-- .highlight .left-row -->
                        ...
                        <li class="highlight lhgh" data-index="2">
                            ...
                            <div class="fl-inner">
                                <h4>Khôi phục những ứng dụng đã xoá</h4>
                                <p>Hiện tại, Appfast không hỗ trợ khôi phục những ứng dụng đã xoá.</p>
                            </div>
                        </li><!-- .highlight .left-row -->
                        ...
                        <li class="highlight lhgh" data-index="3">
                            ...
                            <div class="fl-inner">
                                ...
                                <p>Nhấn vào Quên mật khẩu trong trang Đăng nhập, thực hiện theo hướng dẫn để đặt lại mật
                                    khẩu mới.</p>
                            </div>
                        </li><!-- .highlight .left-row -->
                    </ul>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 right-row">
                    <ul class="features-right">
                        <li class="highlight rhgh" data-index="4">
                            ...
                            <div class="fr-inner">
                                <h4>Định dạng ảnh</h4>
                                <p>Ảnh với định dạng PNG hoặc JPG được cho phép, kích thước tối đa mỗi ảnh là 1.5MB.</p>
                            </div>
                        </li><!-- .highlight .left-row -->
                        <li class="highlight rhgh" data-index="5">
                            ...
                            <div class="fr-inner">
                                <h4>Thông báo đẩy</h4>
                                <p>Thông báo đẩy là chức năng cho phép bạn đưa thông báo đến người dùng.</p>
                            </div>
                        </li><!-- .highlight .left-row -->
                        <li class="highlight rhgh" data-index="6">
                            ...
                            <div class="fr-inner">
                                ...
                                <p>Appfast tích hợp các cổng thanh toán nội địa, visa, paypal và ví điện tử Momo.</p>
                            </div>
                        </li><!-- .highlight .left-row -->
                        <li class="highlight rhgh" data-index="7">
                            <i class="flaticon-coding effect-1"></i>
                            <div class="fr-inner">
                                <h4>SNhập hàng bằng CSV</h4>
                                <p>Bạn có thể nhập thông tin danh sách hàng hoá bằng file CSV.</p>
                            </div>
                        </li><!-- .highlight .left-row -->
                    </ul>
                </div><!-- .row .left-row -->
    ...
    <div class="how-its-work clearfix">
        <div class="hc colon1">
            <h2>1</h2>
            <h3>Mở cửa hàng</h3>
            <p class="lead">Trên các thiết bị di động mở cửa hàng (kho tải ứng dụng của bạn).</p>
        </div><!-- end col -->

        <div class="hc colon2">
            <h2>2</h2>
            <h3>Tạo tài khoản</h3>
            <p class="lead">Tạo hoặc đăng nhập bằng tài khoản phù hợp với nền tảng ứng dụng của thiết bị.</p>
        </div><!-- end col -->

        <div class="hc colon3">
            <h2>3</h2>
            <h3>Tải ứng dụng</h3>
            <p class="lead">Sử dụng thanh công cụ tìm kiếm với từ khóa "Appfast" và tải ứng dụng Appfast</p>
        </div><!-- end col -->

        <div class="hc colon4">
            <h2>4</h2>
            <h3>Sử dụng và đánh giá!</h3>
            <p class="lead">Trải nghiệm ứng dụng và vui lòng để lại những đánh giá hữu ích</p>
        </div><!-- end col -->
    ...
    <div id="screenshots" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Màn hình tính năng ứng dụng</h3>
                <p class="lead">Một số màn hình chức năng của ứng dụng, luôn hướng đến giao diện tốt nhất cho người dùng
                    nên chúng tôi luôn luôn mong muốn người dùng có một trải nghiệm sử dụng tốt nhất</p>
            </div><!-- end title -->
            ...
            <div class="row text-center">
                <div class="col-md-7 col-sm-12">
                    <div class="customwidget text-left">
                        <h1>Tải ứng dụng ở đâu</h1>
                        <p>
                            Hiện tại ứng dụng đã được tải lên các store lớn của các nền tảng IOS, Android và Amazon
                            khách hàng có thể truy cập vào hệ thống store trên thiết bị thông minh và tải về dùng thử.
                            Chúng tôi đang mở rộng để ứng dụng có thể được tải về ở nhiều nền tảng ứng dụng khác.
                        </p>
    ...
    <div id="team" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Nhóm phát triển ứng dụng là đội ngũ có nhiều kinh nghiệm
                    và chuyên môn trong lĩnh vực lập trình và phát triển ứng dụng di động.</p>
            </div><!-- end title -->
    ...
    <div class="parallax section" style="background-image:url('uploads/ben_img_2.jpg');">
        <div class="container">
            <div class="row text-left stat-wrap">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <span data-scroll class="global-radius icon_wrap effect-1 alignleft"><i
                            class="flaticon-amazon-logo"></i></span>
    ...
    <div id="pricing" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Gói dịch vụ hiện có</h3>
                <p class="lead">Ưu đãi tốt nhất <strong>chỉ với $39 trên 1 tháng!</strong> Ước tính doanh thu của bạn có
                    thể phát triển đến 3.5 triệu $.<br> doanh thu phát triển ở mọi lĩnh vực.</p>
            </div><!-- end title -->
                                ...
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-sign-up">
                                            <a href="#" class="btn btn-dark btn-radius btn-brd grd1 effect-1">Mua
                                                ngay</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <div id="testimonials" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Luôn mong muốn sự phục vụ tốt nhất, nên chúng tôi luôn ghi nhận những đánh giá từ phía
                    người dùng! Những đóng góp này sẽ giúp sản phẩm của chúng tôi được hoàn thiện hơn.</p>
            </div><!-- end title -->
    ...
    <div id="purchase" class="parallax section db" style="background-image:url('uploads/pr_bg.jpg');">
        <div class="container">
            <div class="section-title text-center">
                ...
                <h3>Dùng ngay!</h3>
                <p class="lead">Chúng tôi trân trọng cảm ơn những lời nhận xét từ phía người dùng. Từ những đánh giá
                    trên giúp sản phẩm phần mềm của chúng tôi đến tay người dùng với chất lượng ngày càng nâng cao hơn!
                </p>
            </div><!-- end title -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="btn-buy apple-button">
                        <a href="#"><i class="flaticon-android alignleft"></i> Download on the <strong>Google
                                Play</strong></a>
                    </div>
                </div><!-- end col -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="btn-buy apple-button">
                        <a href="#"><i class="flaticon-apple alignleft"></i> Download on the <strong>App
                                Store</strong></a>
                    </div>
                </div><!-- end col -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="btn-buy apple-button">
                        <a href="#"><i class="flaticon-windows alignleft"></i> Download on the
                            ...
                            <fieldset class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 text-center">
                                    <button type="submit" value="SEND" id="submit"
                                        class="btn btn-light btn-radius btn-brd grd1 btn-block">Gửi hỗ trợ</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
    ...
    <section class="section nopad cac text-center">
        <a href="#">
            <h3>Nếu có bất kì thắc mắc nào cho ứng dụng của chúng tôi chỉ cần để lại liên hệ. Đội ngũ tư vấn của chúng
                tôi sẽ hỗ trợ tốt nhất!</h3>
        </a>
    </section>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <p> Appfast là nền tảng giúp bạn tạo ra ứng dụng di động đơn giản, nhanh chóng mà không cần kiến
                            thức lập trình.</p>
                        <p>Appfast tạo ứng dụng dựa trên các widget được định nghĩa sẵn cùng khả năng tùy chỉnh các
                            thuộc tính như màu sắc, hình ảnh, liên kết...</p>
                    </div><!-- end clearfix -->
                </div><!-- end col -->
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="footer-distributed widget clearfix">
                        <div class="widget-title">
                            <h3>Tin mới</h3>
                            <p>Để lại Email của bạn chúng tôi sẽ thông báo đến bạn khi có những cập nhật, chương trình
                                mới từ ứng dụng</p>
                        </div>
                        <div class="footer-right">
                            <form method="get" action="#">
                                <input placeholder="Nhập mail nhận thông báo..." name="search">
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">
                    <p class="footer-company-name">Đăng ký bản quyền. &copy; 2020 <a href="#">Appfast</a> Thiết kế bởi :
                        <a href="https://html.design/">SiVi CODE</a>
                    </p>
                </div>
            </div>
        </div><!-- end container -->
