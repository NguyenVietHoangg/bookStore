<div class="container body">
    <div class="row p-3">
        ...
        <div class="col-12 body_info col-xl-5">
            ...
            <p>Tình Trạng <span><?= printf($sachItem['iSoLuong'] > 0 ? 'Còn Hàng' : 'Hết Hàng')  ?></span></p>
            <p>Số Lượng</p>
            <div class="body-buy d-flex align-items-center">
                <button class="btn" id="reduce" onclick="reduceAction()">
                    -
                </button>
                <input class="ml-3 mr-3" id="soLuong" type="text" disabled />
                <button class="btn" id="increase" onclick="increaseAction()">
                    +
                </button>
            </div>
